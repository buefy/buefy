<template>
    <div class="container">
        ...
        <div class="columns">
            ...
            <div class="column">
                <pre v-highlight><code class="html">{{ ExStylesCode }}</code></pre>
            </div>
        </div>
        ...
        <div class="columns">
            ...
            <div class="column">
                <pre v-highlight><code class="html">{{ ExMultilinedCode }}</code></pre>
            </div>
        </div>
        ...
        <div class="columns">
            ...
            <div class="column">
                <pre v-highlight><code class="html">{{ ExToggleCode }}</code></pre>
            </div>
        </div>
