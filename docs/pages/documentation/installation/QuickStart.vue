<template>
    <div>
        ...
        <h2 class="subtitle"><span class="list-number">2</span> Import and use Buefy. You can also enable individual components</h2>
        <p class="content">
            <b>Note:</b> If you want to use your own theme / variables go to
