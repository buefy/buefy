<template>
    <div class="container">
        ...
        <div class="columns">
            ...
            <div class="column">
                <CodeView :code="ExAutocompleteCode"/>
            </div>
        </div>
