    ...
    <div>
        ...
        <Example :component="ExSlot" :code="ExSlotCode" title="Custom pagination buttons">
            ...
            <b-message type="is-warning" has-icon>
                You have to switch <code>tag</code> between <code>router-link</code> and <code>a</code>, or whichever tag you specify to <code>router-link</code>, according to <code>page.disabled</code> flag in the scoped slot props to prevent navigation to non-existing pages.
            </b-message>
        </Example>
