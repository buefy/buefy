<template>
    <div>
        ...
        <Example :component="ExCustomAsync" :code="ExCustomAsyncCode" title="Async with custom template and infinite scroll">
            ...
            <p>With <code>checkInfiniteScroll</code> and <code>infiniteScroll()</code> event you can listen to the end of the scroll list to implement an infinite scroll strategy.</p>
