export default [
    {
        props: [
            ...
            },
            {
                ...
                description:
                    "Property of the object (if <code>data</code> is array of objects) to use as display text, and to keep track of selected option",
                type: "String",
                values: "—",
            ...
            },
            {
                ...
                description:
                    "Function to format an option to a string for display in the input as alternative to <code>field</code> prop)",
                type: "Function",
                values: "—",
                default: ""
            },
            ...
            },
            {
                ...
                type: "String",
                values:
                    "<code>is-small</code>, <code>is-medium</code>, <code>is-large</code>",
                default: "—"
            },
            {
            ...
            },
            {
                ...
                type: "String",
                values:
                    "<code>mdi</code>, <code>fa</code>, <code>fas</code>, <code>far</code>, <code>fad</code>, <code>fal</code>",
                default: "<code>mdi</code>"
            },
            {
                name: "<code>confirm-keys</code>",
                description:
                    "Array of keys (https://developer.mozilla.org/en-US/docs/Web/API/KeyboardEvent/key/Key_Values) which will select an option when typing (default tab and enter)",
                type: "Array",
                values: "—",
            ...
            },
            {
                ...
                description:
                    "Same as native <code>maxlength</code>, plus character counter",
                type: "String, Number",
                values: "—",
                default: "—"
            },
            {
                ...
                description:
                    "Makes the component check if list reached scroll end and emit <code>infinite-scroll</code> event.",
                type: "Boolean",
                values: "—",
                default: "<code>false</code>"
            },
            ...
            },
            {
                ...
                type: "String",
                values:
                    "<code>top</code>, <code>bottom</code>, <code>auto</code>",
                default: "<code>auto</code>"
            },
            {
                name: "<code>append-to-body</code>",
                description:
                    "Append autocomplete content to body (prevents event bubbling)",
                type: "Boolean",
                values: "—",
                default: "<code>false</code>"
            },
        ...
        slots: [
            {
                ...
                description: "",
                props:
                    "<code>option: String|Object</code>, <code>index: Number</code>"
            },
            {
                name: "<code>empty</code>",
                description:
                    "Show like an option if <code>data</code> array prop is empty",
                props: "—"
            },
            {
        ...
        events: [
            ...
            },
            {
                ...
                parameters:
                    "<code>option: String|Number|Object, event: $event</code>"
            },
            {
            ...
            },
            {
                ...
                description:
                    "Listen to any native event, e.g. <code>click.native</code>",
                parameters: "<code>event: $event</code>"
            },
            {
                name: "<code>infinite-scroll</code>",
                description:
                    "Triggers when <code>.dropdown-list</code> has reached scroll end",
                parameters: "—"
            }
        ],
        methods: [
            {
                ...
                description:
                    "Check validation of HTML5 (add the message and type/color), also updates the <code>isValid</code> property",
                return: "<code>isValid: Boolean</code>"
            },
            {
                name: "<code>focus</code>",
                description:
                    "Set focus (internally uses the native <code>.select()</code> method)",
                return: "—"
            },
            {
                name: "<code>setSelected(selected: Any)</code>",
                description:
                    "Select an option by an object (same type of <code>data</code> property)",
                return: "—"
            }
        ]
    }
