        ...
        <div class="container">
            <div class="columns is-multiline is-variable is-6">
                ...
                <div class="column is-one-third">
                    ...
                    <ul>
                        ...
                        <li><router-link to="/stackblitz">StackBlitz Examples</router-link></li>
                        <li><router-link to="/expo">Expo</router-link></li>
                    </ul>
                </div>

                <!-- Partners -->
                <div class="column is-one-third">
                    <h5 class="title is-6">Partners</h5>
                    <ul>
            ...
            <div class="level mt-5 is-size-7">
                ...
                <div class="level-right has-text-centered-mobile">
                    <div class="level-item">
                        <a class="button is-small" href="https://github.com/buefy/buefy" target="_blank">
                            <b-icon icon="github" />
                        </a>
                        <a class="button is-small is-discord ml-1" href="https://discord.buefy.org" target="_blank">
                            <b-icon icon="discord" />
                        </a>
                        <a class="button is-small is-twitter ml-1" href="https://twitter.com/buefycss" target="_blank">
...
import { BField, BIcon, BInput, BButton } from 'buefy'
</script>
